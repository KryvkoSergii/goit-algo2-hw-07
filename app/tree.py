...
class SplayTree:
    ...
    def _insert_node(self, key, value, current_node: Node):
        """Recursive insertion of an element into the tree."""
        if key < current_node.key:
            if current_node.left_node.key:
    ...
    def find(self, key):
        """Search for an element in the tree using splaying."""
        node = self.root
    ...
    def _splay(self, node):
        """Implementation of splaying to move the node to the root."""
